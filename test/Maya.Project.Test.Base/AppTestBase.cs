...
using Maya.Project.Test.Base.TestData;

namespace Maya.Project.Test.Base
{
    /// <summary>
    ...
    public abstract class AppTestBase<T> : AbpIntegratedTestBase<T> where T : AbpModule
    {
        ...
        protected TResult UsingDbContext<TResult>(Func<ProjectDbContext, TResult> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<TResult> UsingDbContextAsync<TResult>(Func<ProjectDbContext, Task<TResult>> func)
        {
        ...
        protected TResult UsingDbContext<TResult>(int? tenantId, Func<ProjectDbContext, TResult> func)
        {
            TResult result;
        ...
        protected async Task<TResult> UsingDbContextAsync<TResult>(int? tenantId, Func<ProjectDbContext, Task<TResult>> func)
        {
            TResult result;
