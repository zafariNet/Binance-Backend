...
using Maya.Project.Test.Base.DependencyInjection;
using Maya.Project.Test.Base.UiCustomization;
using Maya.Project.Test.Base.Url;
using Maya.Project.Test.Base.Web;
...
namespace Maya.Project.Test.Base
{
    ...
    {
        public ProjectTestBaseModule(ProjectEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
