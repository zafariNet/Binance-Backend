...
using Maya.Project.MultiTenancy.HostDashboard;
...
namespace Maya.Project.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ProjectDbContext context, SubscriptionPayment subscriptionPayment)
        {
