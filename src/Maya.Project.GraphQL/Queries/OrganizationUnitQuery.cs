...
using Maya.Project.Core.Base;
using Maya.Project.Core.Extensions;
using Maya.Project.Dto;
using Maya.Project.Types;

namespace Maya.Project.Queries
{
    public class OrganizationUnitQuery : ProjectQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
