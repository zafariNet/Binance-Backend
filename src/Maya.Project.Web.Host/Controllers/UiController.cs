...
using Maya.Project.Authorization.Accounts;
...
using Maya.Project.Web.Models.Ui;
using Maya.Project.Web.Session;

namespace Maya.Project.Web.Controllers
{
    public class UiController : ProjectControllerBase
    {
