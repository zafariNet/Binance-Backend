...
using Maya.Project.Web.Controllers;
using Maya.Project.Web.Models.Consent;

namespace Maya.Project.Web.Host.Controllers
{
    public class ConsentController : ProjectControllerBase
    {
