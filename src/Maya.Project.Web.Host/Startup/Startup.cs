...
using Maya.Project.Web.Chat.SignalR;
using Maya.Project.Web.Common;
using Swashbuckle.AspNetCore.Swagger;
using Maya.Project.Web.IdentityServer;
using Maya.Project.Web.Swagger;
using Stripe;
...
using Maya.Project.Schemas;
using Maya.Project.Web.HealthCheck;
using Newtonsoft.Json.Serialization;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Maya.Project.Web.Startup
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "Project API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Maya.Project.Web.wwwroot.swagger.ui.index.html");
