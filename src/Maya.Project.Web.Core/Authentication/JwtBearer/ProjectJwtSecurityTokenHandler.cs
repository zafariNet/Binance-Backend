...
namespace Maya.Project.Web.Authentication.JwtBearer
{
    public class ProjectJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public ProjectJwtSecurityTokenHandler()
        {
