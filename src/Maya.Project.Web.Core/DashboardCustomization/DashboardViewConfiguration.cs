...
namespace Maya.Project.Web.DashboardCustomization
{
    public class DashboardViewConfiguration
    {
        ...
        public DashboardViewConfiguration()
        {
            ...
            WidgetFilterViewDefinitions.Add(ProjectDashboardCustomizationConsts.Filters.FilterDateRangePicker,
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(ProjectDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
