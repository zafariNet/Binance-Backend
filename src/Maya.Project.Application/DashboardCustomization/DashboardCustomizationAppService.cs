...
using Maya.Project.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Maya.Project.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ProjectAppServiceBase, IDashboardCustomizationAppService
    {
