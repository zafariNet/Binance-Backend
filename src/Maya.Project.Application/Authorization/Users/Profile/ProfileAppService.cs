...
using Maya.Project.Authentication.TwoFactor.Google;
using Maya.Project.Authorization.Users.Dto;
using Maya.Project.Authorization.Users.Profile.Cache;
using Maya.Project.Authorization.Users.Profile.Dto;
using Maya.Project.Configuration;
using Maya.Project.Friendships;
using Maya.Project.Gdpr;
using Maya.Project.Net.Sms;
using Maya.Project.Security;
using Maya.Project.Storage;
using Maya.Project.Timing;
    ...
    public class ProfileAppService : ProjectAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Maya.Project",
