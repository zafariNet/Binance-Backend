...
using Maya.Project.Migrations.Seed;
using Maya.Project.Migrations.Seed.Host;
...
namespace Maya.Project.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ProjectAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ProjectDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ProjectConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ProjectConsts.ConnectionStringName}", constring);
        }
