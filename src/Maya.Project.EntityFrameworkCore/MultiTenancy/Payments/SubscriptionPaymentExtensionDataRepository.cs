...
using Maya.Project.EntityFrameworkCore.Repositories;

namespace Maya.Project.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : ProjectRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ProjectDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
