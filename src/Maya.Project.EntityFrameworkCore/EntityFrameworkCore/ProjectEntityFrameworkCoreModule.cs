...
using Maya.Project.EntityHistory;
...
namespace Maya.Project.EntityFrameworkCore
{
    ...
    public class ProjectEntityFrameworkCoreModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            // Configuration.EntityHistory.Selectors.Add("ProjectEntities", EntityHistoryHelper.TrackedTypes);
            // Configuration.CustomConfigProviders.Add(new EntityHistoryConfigProvider(Configuration));
        }

        public override void Initialize()
        {
            IocManager.RegisterAssemblyByConvention(typeof(ProjectEntityFrameworkCoreModule).GetAssembly());
        }
