...
using Maya.Project.Editions;
using Maya.Project.MultiTenancy.Demo;
...
namespace Maya.Project.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ProjectConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ProjectConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
