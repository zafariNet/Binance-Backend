...
{
    public class StripeGatewayManager : ProjectServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Project";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ProjectConsts.Currency;
        }
        ...
        private async Task<StripeIdResponse> CreatePlanAsync(string planId, decimal amount, string interval, string productId)
        {
            ...
            var plan = await planService.CreateAsync(new PlanCreateOptions
            {
                ...
                Interval = interval,
                Product = productId,
                Currency = ProjectConsts.Currency
            });
