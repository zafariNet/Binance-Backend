...
using Maya.Project.Authorization.Ldap;
...
using Maya.Project.DashboardCustomization.Definitions;
using Maya.Project.Debugging;
using Maya.Project.DynamicEntityParameters;
using Maya.Project.Features;
using Maya.Project.Friendships;
using Maya.Project.Friendships.Cache;
using Maya.Project.Localization;
using Maya.Project.MultiTenancy;
using Maya.Project.Net.Emailing;
using Maya.Project.Notifications;
using Maya.Project.WebHooks;

namespace Maya.Project
{
    [DependsOn(
        typeof(ProjectCoreSharedModule),
    ...
    public class ProjectCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ProjectMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
