...
namespace Maya.Project.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ProjectServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Maya.Project", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
